...
def gen_sql_by_template(query_id, K, db_name=None):
    ...
    if db_name == 'dsb': # simply use dsb's q gen
        ...
        local_selections = pd.read_csv('lsc/job/local-sel-condition-saved-copy.csv') # MARK: change all BETWEEN and IN conditions
...
# sql_list, sampled_literals = gen_sql_by_template('2a', 2)
# print('sql_list:', sql_list)
# print('sampled_literals:', sampled_literals)